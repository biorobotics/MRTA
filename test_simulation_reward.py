...
def eval_rnet(net, alloc_batch, targets, env_vect):
    ...
    env_vect = numpy_to_input_batch(env_onehot, batch_size)
    alloc_batch = numpy_to_input_batch(alloc_batch, batch_size)
    targets = numpy_to_input_batch(targets, batch_size)
